...
if($lastInsertId)
{
echo "<script type='text/javascript'>alert('Msg send Sucessfull!');</script>";
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p> Jeevan Bharati Building,  Connaught Place , New Delhi - 110001</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>info@examera.com<br>contact@examera.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p> ID +91742873121 <br> ID +91742</p>
                </div>
              </div>
            </div>
